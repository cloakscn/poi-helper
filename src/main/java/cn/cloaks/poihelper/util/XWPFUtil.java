...
public class XWPFUtil {
     ...
     * 日志打印
     */
    private static final Logger log = LoggerFactory.getLogger(XWPFUtil.class);
    ...
    public XWPFUtil(InputStream inputStream, Map<String, Object> globalData) throws IOException {
